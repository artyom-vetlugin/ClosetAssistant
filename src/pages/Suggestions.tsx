      ...
      <div className="bg-blue-50 border border-blue-200 text-blue-900 px-4 py-3 rounded">
        <details>
          ...
          <ul className="mt-2 list-disc list-inside text-sm">
            <li>{t('suggestions:colorWeight', { defaultValue: 'Color harmony (35%): neutrals pair with anything; one bold + neutrals scores well; two bolds need balance; neutral shoes help.' })}</li>
            ...
            <li>{t('suggestions:styleWeight', { defaultValue: 'Style match (20%): higher score when items share cohesive or compatible styles (e.g., casual + casual/athleisure).' })}</li>
