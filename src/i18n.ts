...
const resources = {
  en: {
    ...
    suggestions: {
      ...
      colorWeight: 'Color harmony (35%): neutrals pair with anything; one bold + neutrals scores well; two bolds need balance; neutral shoes help.',
      seasonWeight: 'Season match (35%): items tagged for the chosen season score highest; wrong-season items receive heavy penalties.',
      styleWeight: 'Style match (20%): higher when items share cohesive or compatible styles (e.g., casual + streetwear).',
  ...
  ru: {
    ...
    suggestions: {
      ...
      colorWeight: 'Цветовая гармония (35%): нейтральные цвета сочетаются со всем; один яркий + нейтрали — хорошо; два ярких требуют баланса; нейтральная обувь помогает.',
      seasonWeight: 'Соответствие сезону (35%): вещи для выбранного сезона получают максимум; вещи не по сезону — сильный штраф.',
      styleWeight: 'Соответствие стилю (20%): выше, когда вещи одного или совместимых стилей (напр., кэжуал + уличная).',
