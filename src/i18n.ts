...
const resources = {
  en: {
    ...
    suggestions: {
      ...
      colorWeight: 'Color harmony (45%): neutrals pair with anything; one bold + neutrals scores well; two bolds need balance; neutral shoes help.',
      seasonWeight: 'Season match (40%): items tagged for the chosen season score highest; wrong-season items receive heavy penalties.',
      varietyWeight: 'Variety (15%): balanced mix of colors and all required pieces.',
  ...
  ru: {
    ...
    suggestions: {
      ...
      colorWeight: 'Цветовая гармония (45%): нейтральные цвета сочетаются со всем; один яркий + нейтрали — хорошо; два ярких требуют баланса; нейтральная обувь помогает.',
      seasonWeight: 'Соответствие сезону (40%): вещи для выбранного сезона получают максимум; вещи не по сезону — сильный штраф.',
      varietyWeight: 'Разнообразие (15%): сбалансированный набор цветов и все обязательные элементы.',
